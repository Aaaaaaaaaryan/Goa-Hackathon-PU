...
interface NavbarProps extends RegistrationProps {
  isNavVisible: boolean;
}

export const Navbar: React.FC<NavbarProps> = ({ isNavVisible, isLate, isHackathonStartedAuth, regLink, handleRegisterClick }) => {
  return (
    <motion.nav 
      initial={{ y: 0 }}
    ...
    >
      <div className="font-anton text-3xl text-accent-orange uppercase tracking-wide pointer-events-auto">
        <img src="/parul_university_logo.png" alt="Parul University Goa Campus Logo" className="h-12 md:h-16" />
      </div>
