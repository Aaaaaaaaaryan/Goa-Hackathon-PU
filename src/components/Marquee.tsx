...
export const Marquee: React.FC<MarqueeProps> = ({ text }) => {
  return (
    <div className="bg-accent-orange py-3 md:py-4 transform -rotate-2 scale-110 my-20 md:my-32 overflow-hidden shadow-[0_0_50px_rgba(242,75,40,0.3)] relative z-10 w-full" aria-hidden="true">
